...
const mmap_region_t plat_arm_mmap[] = {
	...
	MAP_REGION_FLAT(0xb0000000,(0xb4000000-0xb0000000),MT_MEMORY | MT_RW |MT_NS), //Test FPGA RW

	MAP_REGION_FLAT(0x900000000,0x100000000,MT_MEMORY | MT_RW |MT_NS), //Other DRAM	

	MAP_REGION_FLAT(0x2b400000,0x10000,MT_DEVICE | MT_RW |MT_SECURE), //GPU MMU
	MAP_REGION_FLAT(0xf8000000,0x6000000,MT_MEMORY | MT_RW|MT_NS), //It is used by FPGA (cma)
	...
	MAP_REGION_FLAT(0x9b0000000,0x050000000,MT_MEMORY | MT_RW|MT_NS), //It is used by FPGA
