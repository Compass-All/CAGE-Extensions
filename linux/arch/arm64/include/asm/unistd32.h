...
#define __NR_ccaext_create_app 398
__SYSCALL(__NR_ccaext_create_app, sys_ccaext_create_app)
#define __NR_ccaext_destory_app 399
__SYSCALL(__NR_ccaext_destory_app, sys_ccaext_destory_app)
/*
